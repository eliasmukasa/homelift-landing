/* app/page.tsx  – HomeLift Africa landing MVP */
  ...
  return (
    <main className="bg-black text-white font-sans">
      ...
      <section
        ...
        style={{ backgroundImage: "url('/sofa-hero.jpg')" }} // change path if needed
      >
        ...
        <p className="mt-6 max-w-xl text-lg text-gray-300">
          Vetted, insured, and continuously trained Home-Care Professionals —
          matched to your household in under 48 hours.
        </p>
      ...
      <section className="max-w-6xl mx-auto py-16 px-6 grid md:grid-cols-2 gap-10">
        <div>
          <h2 className="text-2xl font-bold mb-4">
            Early-Bird Benefits for Households
          </h2>
      ...
      <section className="max-w-4xl mx-auto py-16 px-6 text-center">
        ...
        <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
          Watch a quick 60-second story on why Florence & Elias are on a mission
          to lift the quality of home life in Africa.
        </p>
          ...
          {[1, 2].map((id) => (
            <div key={id} className="bg-gray-800 p-6 rounded-2xl">
              <p className="italic text-gray-300">
                “Placeholder quote – HomeLift matched us with a fantastic
                housekeeper within 24 hours!”
              </p>
      ...
      <section className="max-w-5xl mx-auto py-16 px-6">
        ...
        <details className="bg-gray-900 rounded-xl p-4 mb-4 cursor-pointer">
          ...
          <p className="text-gray-400 mt-2">
            We verify police clearance, NIN, and run reference checks.
          </p>
        </details>

        <details className="bg-gray-900 rounded-xl p-4 mb-4 cursor-pointer">
          <summary className="font-medium">
            What if I’m not happy with the match?
          </summary>
          <p className="text-gray-400 mt-2">
            We offer a free replacement within 48 hours of notice.
          </p>
        </details>
      </section>
