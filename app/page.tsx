    ...
    >
      ...
      <motion.header className="fixed top-0 left-0 right-0 z-50 bg-gray-950 bg-opacity-80 backdrop-blur-sm p-4 flex justify-between items-center shadow-lg">
        <div className="flex items-center">
          {/* Replace with your actual logo image if available, otherwise use text */}
          {/* <img src="/path/to/your/logo.png" alt="HomeLift Africa Logo" className="h-8 mr-3" /> */}
          <span className="text-2xl font-bold text-blue-400">HomeLift Africa</span>
        </div>
